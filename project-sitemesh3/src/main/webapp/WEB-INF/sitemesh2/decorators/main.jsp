...
<jsp:include page="/resources/custom/custom-js.jsp"></jsp:include>
<!doctype html>
<html>
<head>
<meta charset="utf-8" />
<meta name="keywords" content="cookbook, cook, recipe, indian, chinese, american" />
...
<body id="body-wrap">
	...
	<footer class="row">
		<div class="col_16 col">
			all rights reserved &copy; <a href="javascript:void(0)">cookdb
